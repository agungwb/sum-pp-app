...
// 1. Interface yang bersih (children otomatis didapat dari SelectHTMLAttributes)
...
// 2. Destructuring standar, sisanya masuk ke ...props
export const Select = ({ 
  label = '', 
  hasError, 
  colSpan = "1", 
      ...
      {isPercentage ? (
        <div className="flex items-center justify-end gap-2">
          <div className={`basis-4/5 ${colSpanClasses[colSpan] || ""}`}>
            ...
            {/* props.children dipanggil langsung dari props */}
